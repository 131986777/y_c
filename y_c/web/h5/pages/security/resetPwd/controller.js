angular.module('AndSell.H5.Main').controller('pages_security_resetPwd_Controller', function ($scope, $state, $stateParams, securityFactory, $interval, userFactory, modalFactory, weUI) {
