angular.module('AndSell.H5.Main').controller('pages_order_addCoupon_Controller', function ($scope, $state, $stateParams, weUI, personalFactory, modalFactory) {
