...
angular.module('AndSell.Main').controller('analysis_analysis_onlineOrderAnalysis_Controller', function ($scope,http, $stateParams, analysisFactory, modalFactory) {
	
    modalFactory.setTitle("线上商品报表");
    modalFactory.setBottom(false);
    $scope.filter = {};
    
    //初始化
    $scope.initLoad = function () {
    	var title=['商品名称','订单数量','商品销售量','规格','销售额','操作'];
    	$scope.TITLE=title;
