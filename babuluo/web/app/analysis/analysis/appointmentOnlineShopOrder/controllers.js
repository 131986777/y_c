...
angular.module('AndSell.Main').controller('analysis_analysis_appointmentOnlineShopOrder_Controller', function ($scope,http, $stateParams, analysisFactory, modalFactory) {
