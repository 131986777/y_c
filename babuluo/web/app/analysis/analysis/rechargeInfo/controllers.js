angular.module('AndSell.Main').controller('analysis_analysis_rechargeInfo_Controller', function ($q, http, $scope, $stateParams, cardFactory, memberFactory, balanceFactory, modalFactory, shopFactory) {
    modalFactory.setTitle('充值明细');
    modalFactory.setBottom(false);

  var id = $stateParams.id;
  var starttime=  $stateParams.STARTDAY;
  var ENDDAY=  $stateParams.ENDDAY;
 // alert(id+"=="+starttime+"=="+ENDDAY)
   $scope.filters={};
  $scope.filters['FINANCE_LIST.SHOP_ID']=id;
  $scope.filters['FINANCE_LIST.EVENT']="线下充值','会员充值','会员卡充值','充值送','会员卡充值满送";
  $scope.filters['FINANCE_LIST.ADD_DATETIME_FROM']=starttime;
  $scope.filters['FINANCE_LIST.ADD_DATETIME_TO']=ENDDAY;
