    ...
    <div class="col-sm-12">
        <form class="form-horizontal" novalidate="novalidate">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input class="form-control" type="text" ng-model="roleAdd['USER_ROLE.ROLE_NAME']">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-1 right form-input-title">描述</label>
                <div class="col-sm-4">
                    <textarea class="form-control" type="text" ng-model="roleAdd['USER_ROLE.INTRO']"></textarea>
                </div>
            </div>
        </form>
        <form class="form-horizontal" novalidate="novalidate">
