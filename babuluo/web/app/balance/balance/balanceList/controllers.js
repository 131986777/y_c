angular.module('AndSell.Main').controller('balance_balance_balanceList_Controller', function ($q, http, $scope, $stateParams, cardFactory,analysisFactory, memberFactory, balanceFactory, modalFactory, shopFactory) {
