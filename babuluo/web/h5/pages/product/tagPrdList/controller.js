angular.module('AndSell.H5.Main').controller('pages_product_tagPrdList_Controller', function ($location, $anchorScroll, weUI, $scope, $state, $stateParams, productFactory, modalFactory, weUI) {
