//头部引入<meta name="viewport"content="width=device-width,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,user-scalable=no">   商城适配专用
!function(win) {
 function resize() {
  ...
  domEle.style.fontSize = win.rem/2.5 + "px"  
 }
