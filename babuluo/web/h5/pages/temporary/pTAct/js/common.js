!function(t, e) {
    function n(t, e) {
        ...
        var i;
        if (e = e || {},
        this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = e.touchBoundary || 10, this.layer = t, this.tapDelay = e.tapDelay || 200, !n.notNeeded(t)) {
            for (var s = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], a = this, u = 0, c = s.length; c > u; u++) a[s[u]] = r(a[s[u]], a);
            o && (t.addEventListener("mouseover", this.onMouse, !0), t.addEventListener("mousedown", this.onMouse, !0), t.addEventListener("mouseup", this.onMouse, !0)),
    ...
    function(t) {
        ...
        var i = function(t) {
            ...
            function c(t, e) {
                if (t) {
                    ...
                    for (var n = 0,
                    r = t.length; r > n; n++) e[e.length++] = t[n]
                }
            }
            function l() {}
            function f(e, n) {
                ...
                e.os.ios7 = (e.os.ipad || e.os.iphone) && n.match(/7_/) ? !0 : !1,
                ...
                e.os.blackberry10 = n.match(/BB10/) ? !0 : !1,
                e.os.blackberry = e.os.playbook || e.os.blackberry10 || n.match(/BlackBerry/) ? !0 : !1,
                e.os.chrome = n.match(/Chrome/) ? !0 : !1,
                e.os.opera = n.match(/Opera/) ? !0 : !1,
                e.os.fennec = n.match(/fennec/i) ? !0 : n.match(/Firefox/) ? !0 : !1,
                e.os.ie = n.match(/MSIE 10.0/i) || n.match(/Trident\/7/i) ? !0 : !1,
                e.os.ieTouch = e.os.ie && n.toLowerCase().match(/touch/i) ? !0 : !1,
                e.os.tizen = n.match(/Tizen/i) ? !0 : !1,
                e.os.supportsTouch = t.DocumentTouch && T instanceof t.DocumentTouch || "ontouchstart" in t,
                e.os.kindle = n.match(/Silk-Accelerated/) ? !0 : !1,
                e.feat = {};
                var r = T.documentElement.getElementsByTagName("head")[0];
                e.feat.nativeTouchScroll = "undefined" != typeof r.style["-webkit-overflow-scrolling"] && (e.os.ios || e.os.blackberry10),
                e.feat.cssPrefix = e.os.webkit ? "Webkit": e.os.fennec ? "Moz": e.os.ie ? "ms": e.os.opera ? "O": "",
                e.feat.cssTransformStart = e.os.opera ? "(": "3d(",
                e.feat.cssTransformEnd = e.os.opera ? ")": ",0)",
                e.os.android && !e.os.webkit && (e.os.android = !1);
            ...
            function b(t) {
                ...
                function(n, r) {
                    e[n] = function() {
                        return this[r] = B,
                        "stopImmediatePropagation" !== n && "stopPropagation" !== n || (t.cancelBubble = !0, t[n]) ? t[n].apply(t, arguments) : void 0
                    },
                    e[r] = R
                }),
                e
            ...
            function C(t, e) {
                if (t) {
                    var n = t.childNodes;
                    if (n && n.length > 0) for (var r; r < n.length; r++) C(n[r], e);
                    E(t, e)
                }
            }
            var k, T = t.document,
            ...
            I = function(t, e) {
                ...
                if (i.isObject(t) && i.isObject(e)) {
                    ...
                    else for (var r = 0; r < t.length; r++) t[r].parentNode == e && (this[this.length++] = t[r]);
                    return this
                }
                if (i.isObject(t) && e == k) return this[this.length++] = t,
                this;
                if (e !== k) {
            ...
            F.map = function(t, e) {
                var n, r, i, o = [];
                if (F.isArray(t)) for (r = 0; r < t.length; r++) n = e.apply(t[r], [t[r], r]),
                n !== k && o.push(n);
                else if (F.isObject(t)) for (i in t) t.hasOwnProperty(i) && "length" !== i && (n = e(t[i], [t[i], i]), n !== k && o.push(n));
                return o
            },
            F.each = function(t, e) {
                var n, r;
                ...
                } else if (F.isObject(t)) for (r in t) if (t.hasOwnProperty(r) && "length" !== r && e(r, t[r]) === !1) return t;
                return t
            },
            F.extend = function(t) {
            ...
            F.fn = I.prototype = {
                ...
                map: function(t) {
                    var e, n, r = [];
                    for (n = 0; n < this.length; n++) e = t.apply(this[n], [n, this[n]]),
                    e !== k && r.push(e);
                    return F(r)
                },
                each: function(t) {
                ...
                ready: function(t) {
                    return "complete" === T.readyState || "loaded" === T.readyState || !F.os.ie && "interactive" === T.readyState ? t() : T.addEventListener("DOMContentLoaded", t, !1),
                    this
                },
                find: function(t) {
                ...
                html: function(t, e) {
                    ...
                    for (var r = 0; r < this.length; r++) if (e !== !1 && F.cleanUpContent(this[r], !1, !0), L) {
                        var i = this[r];
                ...
                css: function(n, r, i) {
                    ...
                    for (var s = 0; s < this.length; s++) if (F.isObject(n)) for (var a in n) this[s].style[a] = e(a, n[a]);
                ...
                empty: function() {
                    for (var t = 0; t < this.length; t++) F.cleanUpContent(this[t], !1, !0),
                    this[t].textContent = "";
                    return this
                },
                hide: function() {
                ...
                attr: function(t, e) {
                    ...
                    for (var r = 0; r < this.length; r++) if (F.isObject(t)) for (var i in t) F(this[r]).attr(i, t[i]);
                ...
                removeAttr: function(t) {
                    for (var e = function(e) {
                        ...
                        n[r].afmCacheId && N[n[r].afmCacheId] && delete N[n[r].afmCacheId][t]
                    },
                ...
                prop: function(t, e) {
                    ...
                    for (var i = 0; i < this.length; i++) if (F.isObject(t)) for (var o in t) F(this[i]).prop(o, t[o]);
                ...
                removeProp: function(t) {
                    for (var e = function(e) {
                        n[r][e] && (n[r][e] = void 0),
                        n[r].afmCacheId && A[n[r].afmCacheId] && delete A[n[r].afmCacheId][t]
                    },
                    n = this, r = 0; r < this.length; r++) t.split(/\s+/g).forEach(e);
                    return this
                },
                remove: function(t) {
                    ...
                    if (e == k) return this;
                    for (var n = 0; n < e.length; n++) F.cleanUpContent(e[n], !0, !0),
                    e[n] && e[n].parentNode && e[n].parentNode.removeChild(e[n]);
                    return this
                },
                addClass: function(t) {
                    var e = function(t) {
                    ...
                    for (var n = 0; n < this.length; n++) {
                        ...
                        i = [],
                        o = this;
                        t.split(/\s+/g).forEach(e),
                        this[n].className += (r ? " ": "") + i.join(" "),
                        this[n].className = this[n].className.trim()
                    }
                    return this
                },
                removeClass: function(t) {
                    ...
                    n = 0; n < this.length; n++) {
                        if (t == k) return this[n].className = "",
                        this;
                        var i = this[n].className;
                        "object" == typeof this[n].className && (i = " "),
                        t.split(/\s+/g).forEach(e),
                        this[n].className = i.length > 0 ? i.trim() : ""
                    }
                    return this
                },
                toggleClass: function(t, e) {
                    if (t == k) return this;
                    for (var n = 0; n < this.length; n++)"boolean" != typeof e && (e = this.hasClass(t, this[n])),
                    F(this[n])[e ? "removeClass": "addClass"](t);
                    return this
                },
                replaceClass: function(t, e) {
                    ...
                    i = 0; i < this.length; i++) if (t != k) {
                        var o = this[i].className;
                        t.split(/\s+/g).concat(e.split(/\s+/g)).forEach(n),
                        o = o.trim(),
                ...
                append: function(e, r, i) {
                    if (e && e.length != k && 0 === e.length) return this; (F.isArray(e) || F.isObject(e)) && (e = F(e));
                    var o, s;
                    for (r && F(this).add(r), o = 0; o < this.length; o++) if (e.length && "string" != typeof e) e = F(e),
                    n(e, this[o], i);
                    else {
                        var a = j.test(e) ? F(e) : void 0;
                        if ((a == k || 0 === a.length) && (a = T.createTextNode(e)), a instanceof I) for (var u = 0,
                        c = a.length; c > u; u++) s = a[u],
                        s.nodeName == k || "script" !== s.nodeName.toLowerCase() || s.type && "text/javascript" !== s.type.toLowerCase() ? n(F(s), this[o], i) : t.eval(s.innerHTML);
                ...
                parent: function(t, e) {
                    if (0 === this.length) return this;
                    for (var n = [], r = 0; r < this.length; r++) for (var i = this[r]; i.parentNode && i.parentNode !== T && (n.push(i.parentNode), i.parentNode && (i = i.parentNode), e););
                ...
                serialize: function() {
                    ...
                    for (var t = function(t) {
                        ...
                        if ("fieldset" !== t.nodeName.toLowerCase() && !t.disabled && "submit" !== n && "reset" !== n && "button" !== n && ("radio" !== n && "checkbox" !== n || t.checked) && t.getAttribute("name")) if ("select-multiple" === t.type) for (var r = 0; r < t.options.length; r++) t.options[r].selected && e.push(t.getAttribute("name") + "=" + encodeURIComponent(t.options[r].value));
            ...
            F.ajax = function(e) {
                ...
                try {
                    ...
                    null === o.crossDomain && (o.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(o.url) && RegExp.$2 !== t.location.host),
                    o.crossDomain || (o.headers = F.extend({
                    ...
                    n.onreadystatechange = function() {
                        ...
                        if (4 === n.readyState) {
                            ...
                            if (n.status >= 200 && n.status < 300 || 0 === n.status && "file:" === c) {
                                ...
                                0 === n.status && 0 === i.length && (s = !0),
                                s ? (o.error.call(u, n, "parsererror", s), r.reject.call(u, n, "parsererror", s)) : (r.resolve.call(u, i, "success", n), o.success.call(u, i, "success", n))
                            } else s = !0,
                            r.reject.call(u, n, "error"),
                            o.error.call(u, n, "error");
                    ...
                    o.contentType && (o.headers["Content-Type"] = o.contentType);
                    for (var f in o.headers)"string" == typeof o.headers[f] && n.setRequestHeader(f, o.headers[f]);
                    if (o.beforeSend.call(u, n, o) === !1) return n.abort(),
                    !1;
                    o.timeout > 0 && (a = setTimeout(function() {
                        n.onreadystatechange = l,
                        n.abort(),
                        o.error.call(u, n, "timeout")
                    },
                    o.timeout)),
                    n.send(o.data)
                } catch(h) {
                    r.resolve(u, n, "error", h),
                    o.error.call(u, n, "error", h)
                }
                return n
            },
            F.get = function(t, e) {
            ...
            F.getScript = function(t, e) {
                ...
                if (n) {
                    ...
                    return i.onload = function() {
                        e && e(),
                        r.resolve.call(this, "success"),
                        F(this).remove()
                    },
                    i.onerror = function() {
                        F(this).remove(),
                        r.reject.call(this, "success")
                    },
            ...
            F.param = function(t, e) {
                ...
                else for (var r in t) if (!F.isFunction(t[r])) {
                    var i = e ? e + "[" + r + "]": r,
                    o = t[r];
            ...
            F.create = function(t, e) {
                var n, r = new I;
                if (e || "<" !== t[0]) {
                    e.html && (e.innerHTML = e.html, delete e.html),
                    n = T.createElement(t);
                    for (var i in e) n[i] = e[i];
                    r[r.length++] = n
                } else n = T.createElement("div"),
                L ? MSApp.execUnsafeLocalFunction(function() {
                    n.innerHTML = t.trim()
                }) : n.innerHTML = t,
                c(n.childNodes, r);
            ...
            F.fn.bind = function(t, e) {
                for (var n = 0,
                r = this.length; r > n; n++) m(this[n], t, e);
                return this
            },
            F.fn.unbind = function(t, e) {
                for (var n = 0,
                r = this.length; r > n; n++) y(this[n], t, e);
                return this
            },
            ...
            F.fn.delegate = function(t, e, n, r) {
                ...
                for (var i = 0,
                o = this.length; o > i; i++) x(this[i], e, r, t, n);
                return this
            },
            F.fn.undelegate = function(t, e, n) {
                for (var r = 0,
                i = this.length; i > r; r++) y(this[r], e, n, t);
                return this
            },
            F.fn.on = function(t, e, n, r) {
                return F.isFunction(n) && (r = n, n = null),
                e === k || F.isFunction(e) ? this.bind(t, e) : this.delegate(e, t, n, r)
            },
            ...
            F.fn.trigger = function(t, e, n) {
                "string" == typeof t && (n = n || {},
                t = d(t), n.ns = t.ns, t = F.Event(t.e, n)),
                t.data = e;
                for (var r = 0,
                i = this.length; i > r; r++) this[r].dispatchEvent(t);
                return this
            },
            F.Event = function(t, e) {
                ...
                return n.initEvent(t, r, !0, null, null, null, null, null, null, null, null, null, null, null, null),
                n
            },
            F.bind = function(t, e, n) {
                if (t) {
                    ...
                    F.isArray(e) || (e = [e]);
                    for (var r = 0; r < e.length; r++) t.__events[e[r]] || (t.__events[e[r]] = []),
                    t.__events[e[r]].push(n)
                }
            },
            F.trigger = function(t, e, n) {
                if (t) {
                    ...
                    F.isArray(e) || (e = [e]),
                    F.isArray(n) || (n = []);
                    for (var i = 0; i < e.length; i++) if (t.__events[e[i]]) for (var o = t.__events[e[i]].slice(0), s = 0; s < o.length; s++) F.isFunction(o[s]) && o[s].apply(t, n) === !1 && (r = !1);
                    return r
                }
            },
            F.unbind = function(t, e, n) {
                if (t.__events) {
                    ...
                    F.isArray(e) || (e = [e]);
                    for (var r = 0; r < e.length; r++) if (t.__events[e[r]]) for (var i = t.__events[e[r]], o = 0; o < i.length; o++) if (n == k && delete i[o], i[o] === n) {
                        i.splice(o, 1);
                        break
                    }
                }
            ...
            return F.parseJS = function(e) {
                if (e) {
                    ...
                    e = null;
                    for (var i = 0; i < r.length; i++) if (r[i].src.length > 0 && !z[r[i].src] && !L) {
            ...
            ["focus", "blur"].forEach(function(t) {
                F.fn[t] = function(e) {
                    if (0 !== this.length) {
                        if (e) this.bind(t, e);
                        else for (var n = 0; n < this.length; n++) try {
                            this[n][t]()
                        } catch(r) {}
                        return this
                    }
        ...
        e.jq = i,
        "$" in e || (e.$ = i),
        "function" == typeof t && t.amd ? t("appframework", [],
        function() {
            "use strict";
            return i
    ...
    n.prototype.sendClick = function(t, n) {
        ...
        r.initMouseEvent(this.determineEventType(t), !0, !0, e, 1, i.screenX, i.screenY, i.clientX, i.clientY, !1, !1, !1, !1, 0, null),
    ...
    n.prototype.onTouchStart = function(t) {
        ...
        if (n = this.getTargetElementFromEventTarget(t.target), r = t.targetTouches[0], s) {
            ...
            if (!a) {
                if (r.identifier === this.lastTouchIdentifier) return t.preventDefault(),
                !1;
    ...
    "undefined" != typeof t && t("libs/fastclick",
    function() {
        "use strict";
        return n
    }),
    function() {
        ...
        "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = T), exports._ = T) : e._ = T,
        T.VERSION = "1.6.0";
        var w = T.each = T.forEach = function(t, e, n) {
            ...
            if (h && t.forEach === h) t.forEach(e, n);
                ...
                for (var i = 0,
                o = t.length; o > i; i++) if (e.call(n, t[i], i, t) === r) return
            } else for (var s = T.keys(t), i = 0, o = s.length; o > i; i++) if (e.call(n, t[s[i]], s[i], t) === r) return;
            return t
        };
        T.map = T.collect = function(t, e, n) {
            var r = [];
            return null == t ? r: p && t.map === p ? t.map(e, n) : (w(t,
            function(t, i, o) {
        ...
        T.reduce = T.foldl = T.inject = function(t, e, n, r) {
            ...
            if (null == t && (t = []), d && t.reduce === d) return r && (e = T.bind(e, r)),
        ...
        T.reduceRight = T.foldr = function(t, e, n, r) {
            var i = arguments.length > 2;
            if (null == t && (t = []), g && t.reduceRight === g) return r && (e = T.bind(e, r)),
        ...
        T.filter = T.select = function(t, e, n) {
            var r = [];
            return null == t ? r: v && t.filter === v ? t.filter(e, n) : (w(t,
            function(t, i, o) {
        ...
        T.every = T.all = function(t, e, n) {
            e || (e = T.identity);
            var i = !0;
            return null == t ? i: m && t.every === m ? t.every(e, n) : (w(t,
            function(t, o, s) {
        ...
        var S = T.some = T.any = function(t, e, n) {
            e || (e = T.identity);
            var i = !1;
            return null == t ? i: y && t.some === y ? t.some(e, n) : (w(t,
            function(t, o, s) {
                return i || (i = e.call(n, t, o, s)) ? r: void 0
            }), !!i)
        };
        T.contains = T.include = function(t, e) {
            return null == t ? !1 : b && t.indexOf === b ? -1 != t.indexOf(e) : S(t,
            function(t) {
                return t === e
            })
        },
        ...
        var N = function(t, e, n) {
            return e && T.every(t, T.isArray) ? c.apply(n, t) : (w(t,
            function(t) {
        ...
        T.uniq = T.unique = function(t, e, n, r) {
            ...
            s = [];
            return w(i,
            function(n, r) { (e ? r && s[s.length - 1] === n: T.contains(s, n)) || (s.push(n), o.push(t[r]))
            }),
            o
        },
        T.union = function() {
        ...
        T.indexOf = function(t, e, n) {
            ...
            i = t.length;
            if (n) {
                if ("number" != typeof n) return r = T.sortedIndex(t, e),
                t[r] === e ? r: -1;
        ...
        T.partial = function(t) {
            ...
            return function() {
                for (var n = 0,
                r = e.slice(), i = 0, o = r.length; o > i; i++) r[i] === T && (r[i] = arguments[n++]);
        ...
        T.throttle = function(t, e, n) {
            ...
            return function() {
                ...
                return r = this,
                i = arguments,
                0 >= l ? (clearTimeout(s), s = null, a = c, o = t.apply(r, i), r = i = null) : s || n.trailing === !1 || (s = setTimeout(u, l)),
                o
            }
        },
        ...
        T.invert = function(t) {
            for (var e = {},
            n = T.keys(t), r = 0, i = n.length; i > r; r++) e[t[n[r]]] = n[r];
            return e
        },
        ...
        T.pick = function(t) {
            var e = {},
            n = c.apply(i, u.call(arguments, 1));
            return w(n,
            function(n) {
                n in t && (e[n] = t[n])
            }),
        ...
        T.clone = function(t) {
            return T.isObject(t) ? T.isArray(t) ? t.slice() : T.extend({},
            t) : t
        },
        T.tap = function(t, e) {
            return e(t),
        ...
        var M = function(t, e, n, r) {
            ...
            c = !0;
            if ("[object Array]" == i) {
                if (u = t.length, c = u == e.length) for (; u--&&(c = M(t[u], e[u], n, r)););
            } else {
                for (var f in t) if (T.has(t, f) && (u++, !(c = T.has(e, f) && M(t[f], e[f], n, r)))) break;
                if (c) {
                    for (f in e) if (T.has(e, f) && !u--) break;
                    c = !u
                }
            }
            return n.pop(),
        ...
        w(["Arguments", "Function", "String", "Number", "Date", "RegExp"],
        function(t) {
            T["is" + t] = function(e) {
        ...
        T.each(["escape", "unescape"],
        function(t) {
            T[t] = function(e) {
                return null == e ? "": ("" + e).replace(I[t],
                function(e) {
                    return L[t][e]
                })
            }
        ...
        T.template = function(t, e, n) {
            ...
            t.replace(i,
            function(e, n, r, i, a) {
                return s += t.slice(o, a).replace(B,
                function(t) {
                    return "\\" + P[t]
                }),
        ...
        T.mixin(T),
        w(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"],
        function(t) {
            var e = i[t];
        ...
        "function" == typeof t && t.amd && t("underscore", [],
        function() {
            return T
        })
    }.call(this),
    ...
    function(t) {
        ...
        e.__FastClick__ || (e.__FastClick__ = new n(document.body)),
        NODEB.alias({
            af: "appframework",
