angular.module('AndSell.H5.Main').controller('pages_order_detail_Controller', function ($scope, $state, $stateParams, $q, balanceFactory, http, weUI, productFactory, promoFactory, orderFactory, modalFactory, weUI) {
