angular.module('AndSell.H5.Main').controller('pages_order_detail_Controller', function ($scope, $state, $stateParams,http, weUI, productFactory, promoFactory ,orderFactory, modalFactory, weUI) {
