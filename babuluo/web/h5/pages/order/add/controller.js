angular.module('AndSell.H5.Main').controller('pages_order_add_Controller', function ($scope, $state,balanceFactory, $stateParams, weUI, $http,http ,couponFactory,productFactory, orderFactory, modalFactory, weUI) {
