angular.module('AndSell.H5.Main').controller('pages_order_CashOnDeliveryOrder_list_Controller', function ($scope, $state, $stateParams,orderFactory,modalFactory,weUI) {
