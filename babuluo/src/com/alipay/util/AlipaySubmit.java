...
public class AlipaySubmit {
     ...
     * @return 要请求的参数数组
     */
    public static String getRequestParams(Map<String, String> sParaTemp, String key) {
        //除去数组中的空值和签名参数
        Map<String, String> sPara = AlipayCore.paraFilter(sParaTemp);
        //生成签名结果
        String mysign = buildRequestMysign(sPara, key);
    ...
    public static void main(String[] args) {
        ...
        sParaTemp.put("out_trade_no", "500");
        sParaTemp.put("total_fee", "1");
        sParaTemp.put("body", "haha");
        sParaTemp.put("subject", "500");
        //除去数组中的空值和签名参数
        Map<String, String> sPara = AlipayCore.paraFilter(sParaTemp);
        HttpClientUtil.doGet("https://mapi.alipay.com/gateway.do",
            buildRequestPara(sPara, "sy6zcif7m285u4htm311yytz6eyks7ce"));
    }
}
