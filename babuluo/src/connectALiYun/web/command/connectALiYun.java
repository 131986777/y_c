package connectALiYun.web.command;
...
public class connectALiYun extends HttpServlet {
    ...
    private String accessKeySecret = "kYSyEoB00SZje6GCaS8yqhZzNt6Mkd";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      //   int serviceId =  UserHelper.getServiceID(request);
        ...
        System.out.println("policy为"+policy);
       ...
       /* Map<String, String> result = new HashMap();
        result.put("filePath", serviceId + "");
        result.put("encodePolicy", encodePolicy);
        result.put("signaturecom", signaturecom);
*/


       /* JsonResultUtil.instance().putExtraData("filePath", serviceId + "").json();
        JsonResultUtil.instance().putExtraData("encodePolicy", encodePolicy).json();
        JsonResultUtil.instance().putExtraData("signaturecom", signaturecom).json();*/

        System.out.println(content);
       // return JsonResultUtil.instance().addData(result).json();
